...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__action__Navigation_Goal__rosidl_typesupport_introspection_c__Navigation_Goal_message_member_array[2] = {
  {
    "target_x",  // name
    ...
    offsetof(robot_interfaces__action__Navigation_Goal, target_x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces__action__Navigation_Goal, target_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__action__Navigation_Result__rosidl_typesupport_introspection_c__Navigation_Result_message_member_array[2] = {
  {
    "success",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces__action__Navigation_Result, message),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__MessageMember robot_interfaces__action__Navigation_Feedback__rosidl_typesupport_introspection_c__Navigation_Feedback_message_member_array[3] = {
  {
    "current_x",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_DOUBLE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces__action__Navigation_Feedback, current_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robot_interfaces__action__Navigation_Feedback, current_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
