    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation_Goal')
            logger.debug(
...
class Metaclass_Navigation_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigation_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Navigation_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_interfaces.action import Navigation
...
class Navigation_SendGoal_Request(metaclass=Metaclass_Navigation_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robot_interfaces/Navigation_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'Navigation_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_interfaces.action._navigation import Navigation_Goal
...
class Metaclass_Navigation_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_interfaces.action import _navigation
...
class Navigation_SendGoal(metaclass=Metaclass_Navigation_SendGoal):
    from robot_interfaces.action._navigation import Navigation_SendGoal_Request as Request
    from robot_interfaces.action._navigation import Navigation_SendGoal_Response as Response
...
class Navigation_GetResult_Response(metaclass=Metaclass_Navigation_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robot_interfaces/Navigation_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'Navigation_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_interfaces.action._navigation import Navigation_Result
...
class Metaclass_Navigation_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigation_GetResult(metaclass=Metaclass_Navigation_GetResult):
    from robot_interfaces.action._navigation import Navigation_GetResult_Request as Request
    from robot_interfaces.action._navigation import Navigation_GetResult_Response as Response
...
class Metaclass_Navigation_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigation_FeedbackMessage(metaclass=Metaclass_Navigation_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robot_interfaces/Navigation_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robot_interfaces', 'action'], 'Navigation_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robot_interfaces.action._navigation import Navigation_Feedback
...
class Metaclass_Navigation(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.action.Navigation')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigation(metaclass=Metaclass_Navigation):
    ...
    from robot_interfaces.action._navigation import Navigation_Goal as Goal
    # The result message defined in the action definition.
    from robot_interfaces.action._navigation import Navigation_Result as Result
    # The feedback message defined in the action definition.
    from robot_interfaces.action._navigation import Navigation_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robot_interfaces.action._navigation import Navigation_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robot_interfaces.action._navigation import Navigation_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robot_interfaces.action._navigation import Navigation_FeedbackMessage as FeedbackMessage
