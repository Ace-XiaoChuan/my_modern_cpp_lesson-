...
class GetRobotStatus_Response(metaclass=Metaclass_GetRobotStatus_Response):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.battery_level = kwargs.get('battery_level', str())
        self.x = kwargs.get('x', float())
        self.y = kwargs.get('y', float())
        self.z = kwargs.get('z', float())
        self.has_task = kwargs.get('has_task', bool())
    ...
    def __eq__(self, other):
        ...
        if self.z != other.z:
            return False
        if self.has_task != other.has_task:
            return False
        return True
    ...
    def battery_level(self, value):
        if __debug__:
            assert \
                ...
                "The 'battery_level' field must be of type 'str'"
    ...
    def has_task(self, value):
        if __debug__:
            assert \
                ...
                "The 'has_task' field must be of type 'bool'"
        self._has_task = value
...
class Metaclass_GetRobotStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robot_interfaces.srv.GetRobotStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robot_interfaces.srv import _get_robot_status
...
class GetRobotStatus(metaclass=Metaclass_GetRobotStatus):
    from robot_interfaces.srv._get_robot_status import GetRobotStatus_Request as Request
    from robot_interfaces.srv._get_robot_status import GetRobotStatus_Response as Response
